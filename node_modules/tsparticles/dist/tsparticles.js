...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "particlesJS", function() { return /* reexport */ index_slim["particlesJS"]; });
__webpack_require__.d(__webpack_exports__, "pJSDom", function() { return /* reexport */ index_slim["pJSDom"]; });
__webpack_require__.d(__webpack_exports__, "tsParticles", function() { return /* reexport */ index_slim["tsParticles"]; });
...
// CONCATENATED MODULE: ./dist/Plugins/Absorbers/Absorber.js


class Absorber_Absorber {
  constructor(absorbers, options, position) {
    var _a, _b;
    ...
    if (random) {
      size = Utils["a" /* Utils */].randomInRange(minSize, size);
    }
    ...
    this.color = (_a = ColorUtils["a" /* ColorUtils */].colorToRgb(color)) !== null && _a !== void 0 ? _a : {
      b: 0,
      g: 0,
      r: 0
    };
  ...
  resize() {
    ...
    this.position = initialPosition && Utils["a" /* Utils */].isPointInside(initialPosition, this.container.canvas.size) ? initialPosition : this.calcPosition();
  }
  ...
  draw(context) {
    ...
    context.closePath();
    context.fillStyle = ColorUtils["a" /* ColorUtils */].getStyleFromColor(this.color, this.opacity);
    context.fill();
  }
...
class Absorbers_Absorbers {
  ...
  handleClickMode(mode) {
    ...
    if (mode === ClickMode["a" /* ClickMode */].absorber) {
      let absorbersModeOptions;
      const modeAbsorbers = options.interactivity.modes.absorbers;

      if (modeAbsorbers instanceof Array) {
        if (modeAbsorbers.length > 0) {
          absorbersModeOptions = Utils["a" /* Utils */].itemFromArray(modeAbsorbers);
        }
      } else {
        absorbersModeOptions = modeAbsorbers;
      }

      const absorbersOptions = absorbersModeOptions !== null && absorbersModeOptions !== void 0 ? absorbersModeOptions : options.absorbers instanceof Array ? Utils["a" /* Utils */].itemFromArray(options.absorbers) : options.absorbers;
      const aPosition = container.interactivity.mouse.clickPosition;
      const absorber = new Absorber_Absorber(this, absorbersOptions, aPosition);
      this.addAbsorber(absorber);
    }
  }
...
class AbsorbersPlugin_AbsorbersPlugin {
  ...
  needsPlugin(container) {
    ...
    if (absorbers instanceof Array) {
      ...
      loadAbsorbers = true;
    } else if (Utils["a" /* Utils */].isInArray(ClickMode["a" /* ClickMode */].absorber, options.interactivity.events.onClick.mode)) {
      loadAbsorbers = true;
    }
...
// EXTERNAL MODULE: ./dist/Enums/SizeMode.js
var SizeMode = __webpack_require__(21);

// EXTERNAL MODULE: ./dist/Options/Classes/Emitters/EmitterSize.js
var EmitterSize = __webpack_require__(22);

// CONCATENATED MODULE: ./dist/Plugins/Emitters/Emitter.js




class Emitter_Emitter {
  constructor(emitters, emitterOptions, position) {
    var _a, _b, _c;

    this.emitters = emitters;
    this.container = emitters.container;
    this.initialPosition = position;
    this.emitterOptions = Utils["a" /* Utils */].deepExtend({}, emitterOptions);
    this.position = (_a = this.initialPosition) !== null && _a !== void 0 ? _a : this.calcPosition();
    let particlesOptions = Utils["a" /* Utils */].deepExtend({}, this.emitterOptions.particles);
    ...
    this.size = (_b = this.emitterOptions.size) !== null && _b !== void 0 ? _b : (() => {
      const size = new EmitterSize["a" /* EmitterSize */]();
      size.load({
        height: 0,
        width: 0,
        mode: SizeMode["a" /* SizeMode */].percent
      });
      return size;
    })();
  ...
  emit() {
    ...
    const offset = {
      x: this.size.mode === SizeMode["a" /* SizeMode */].percent ? container.canvas.size.width * this.size.width / 100 : this.size.width,
      y: this.size.mode === SizeMode["a" /* SizeMode */].percent ? container.canvas.size.height * this.size.height / 100 : this.size.height
    };

    for (let i = 0; i < this.emitterOptions.rate.quantity; i++) {
      const particle = new Particle["a" /* Particle */](container, {
...
class Emitters_Emitters {
  ...
  handleClickMode(mode) {
    ...
    if (mode === ClickMode["a" /* ClickMode */].emitter) {
      let emitterModeOptions;
      const modeEmitters = options.interactivity.modes.emitters;

      if (modeEmitters instanceof Array) {
        if (modeEmitters.length > 0) {
          emitterModeOptions = Utils["a" /* Utils */].itemFromArray(modeEmitters);
        }
      } else {
        emitterModeOptions = modeEmitters;
      }

      const emitterOptions = emitterModeOptions !== null && emitterModeOptions !== void 0 ? emitterModeOptions : options.emitters instanceof Array ? Utils["a" /* Utils */].itemFromArray(options.emitters) : options.emitters;
      const ePosition = container.interactivity.mouse.clickPosition;
      const emitter = new Emitter_Emitter(this, Utils["a" /* Utils */].deepExtend({}, emitterOptions), ePosition);
      this.addEmitter(emitter);
    }
  }
...
// CONCATENATED MODULE: ./dist/Plugins/PolygonMask/PolygonMask.js
...
class PolygonMask_PolygonMask {
  ...
  static drawPolygonMask(context, rawData, stroke) {
    const color = typeof stroke.color === "string" ? ColorUtils["a" /* ColorUtils */].stringToRgb(stroke.color) : ColorUtils["a" /* ColorUtils */].colorToRgb(stroke.color);
    ...
    if (color) {
      ...
      context.closePath();
      context.strokeStyle = ColorUtils["a" /* ColorUtils */].getStyleFromColor(color);
      context.lineWidth = stroke.width;
      context.stroke();
    }
  }
  ...
  static drawPolygonMaskPath(context, path, stroke, position) {
    ...
    if (color) {
      context.strokeStyle = ColorUtils["a" /* ColorUtils */].getStyleFromColor(color, stroke.opacity);
      context.lineWidth = stroke.width;
      context.stroke(path);
    }
  }
  ...
  checkInsidePolygon(position) {
    ...
    if (!options.polygon.enable || options.polygon.type === PolygonMaskType["a" /* PolygonMaskType */].none || options.polygon.type === PolygonMaskType["a" /* PolygonMaskType */].inline) {
      return true;
    }

    if (!this.raw) {
      throw new Error(Constants["a" /* Constants */].noPolygonFound);
    }
    ...
    if (options.polygon.type === PolygonMaskType["a" /* PolygonMaskType */].inside) {
      return inside;
    } else if (options.polygon.type === PolygonMaskType["a" /* PolygonMaskType */].outside) {
      return !inside;
    }
  ...
  resize() {
    ...
    if (options.polygon.enable && options.polygon.type !== PolygonMaskType["a" /* PolygonMaskType */].none) {
  ...
  randomPointInPolygon() {
    ...
    if (options.polygon.type === PolygonMaskType["a" /* PolygonMaskType */].inline) {
      switch (options.polygon.inline.arrangement) {
        case PolygonMaskInlineArrangement["a" /* PolygonMaskInlineArrangement */].randomPoint:
          position = this.getRandomPointOnPolygonPath();
          break;

        case PolygonMaskInlineArrangement["a" /* PolygonMaskInlineArrangement */].randomLength:
          position = this.getRandomPointOnPolygonPathByLength();
          break;

        case PolygonMaskInlineArrangement["a" /* PolygonMaskInlineArrangement */].equidistant:
          position = this.getEquidistantPointOnPolygonPathByIndex(container.particles.count);
          break;

        case PolygonMaskInlineArrangement["a" /* PolygonMaskInlineArrangement */].onePerPoint:
        case PolygonMaskInlineArrangement["a" /* PolygonMaskInlineArrangement */].perPoint:
        default:
  ...
  particlesInitialization() {
    ...
    if (options.polygon.enable && options.polygon.type === PolygonMaskType["a" /* PolygonMaskType */].inline && (options.polygon.inline.arrangement === PolygonMaskInlineArrangement["a" /* PolygonMaskInlineArrangement */].onePerPoint || options.polygon.inline.arrangement === PolygonMaskInlineArrangement["a" /* PolygonMaskInlineArrangement */].perPoint)) {
  ...
  particleBounce(particle, _delta) {
    ...
    if (options.polygon.enable && options.polygon.type !== PolygonMaskType["a" /* PolygonMaskType */].none && options.polygon.type !== PolygonMaskType["a" /* PolygonMaskType */].inline) {
      if (!this.checkInsidePolygon(particle.position)) {
        PolygonMask_PolygonMask.polygonBounce(particle);
        return true;
      }
    } else if (options.polygon.enable && options.polygon.type === PolygonMaskType["a" /* PolygonMaskType */].inline) {
      if (particle.initialPosition) {
        const dist = Utils["a" /* Utils */].getDistance(particle.initialPosition, particle.position);
      ...
      for (const path of this.paths) {
        ...
        if (context) {
          if (path2dSupported && path2d && this.offset) {
            PolygonMask_PolygonMask.drawPolygonMaskPath(context, path2d, polygonDraw.stroke, this.offset);
          } else if (rawData) {
            PolygonMask_PolygonMask.drawPolygonMask(context, rawData, polygonDraw.stroke);
          }
        }
      }
    }
  ...
  drawPointsOnPolygonPath() {
    ...
    if (this.raw) {
      for (const item of this.raw) {
        ...
        container.particles.addParticle(new Particle["a" /* Particle */](container, position));
      }
    }
  }

  getRandomPointOnPolygonPath() {
    if (!this.raw || !this.raw.length) throw new Error(Constants["a" /* Constants */].noPolygonDataLoaded);
    const coords = Utils["a" /* Utils */].itemFromArray(this.raw);
    return {
      x: coords.x,
      y: coords.y
    };
  ...
  getRandomPointOnPolygonPathByLength() {
    ...
    const container = this.container;
    const options = container.options;
    if (!this.raw || !this.raw.length || !this.paths.length) throw new Error(Constants["a" /* Constants */].noPolygonDataLoaded);
    const path = Utils["a" /* Utils */].itemFromArray(this.paths);
...
class PolygonMaskPlugin_PolygonMaskPlugin {
  ...
  getPlugin(container) {
    return new PolygonMask_PolygonMask(container);
  }
...
// EXTERNAL MODULE: ./dist/index.slim.js + 69 modules
var index_slim = __webpack_require__(16);
...
index_slim["tsParticles"].addPlugin(new AbsorbersPlugin_AbsorbersPlugin());
index_slim["tsParticles"].addPlugin(new EmittersPlugin_EmittersPlugin());
index_slim["tsParticles"].addPlugin(new PolygonMaskPlugin_PolygonMaskPlugin());
